...
* **Low-effort contributions** - While creating visual media is helpful, creating a pretty image with our tagline, or stickers for different social media platforms only helps so much. If you are going to create contributions, let them be vehicles for understanding the protocol.
