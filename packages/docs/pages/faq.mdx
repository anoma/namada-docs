...
**A:** The Ethereum Bridge is not yet implemented as of 0.17.5. Keep an eye on the [Changelog](https://github.com/anoma/namada/tree/main/.changelog) 👀 to see when it will be officially released.
