...
[Namada](https://namada.net/) is built with architectural components from [Anoma](https://anoma.net).
Namada's cryptographical features give users asset-agnostic, interchain privacy, and is built by a public good laboratory called [Heliax](https://heliax.dev).
...
- [Multi-Asset Shielded Pool](./users/shielded-accounts/shielded-transfers) (MASP)
- Convert Circuit ([shielded set rewards](./users/shielded-accounts/shielded-rewards))
- [Ledger](./users/wallet/hardware-wallet) application
