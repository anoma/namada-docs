...
- Namada public testnet 11:
  - From date: 01st of August 2023 17.00 UTC
  - Namada protocol version: `v0.20.1`
  - Cometbft version: `0.37.2`
  - CHAIN_ID: `public-testnet-11.3aaeae0d49ea`
...
For questions or feedback, please use [GitHub](https://github.com/anoma/namada/issues) or [Discord](https://discord.gg/namada). Don't forget to [follow Namada](https://twitter.com/namadanetwork) on Twitter for fun memes and testnet relevant updates.
