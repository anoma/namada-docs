...
No upgrade needed on `public-testnet-11` (yet).

## Latest Testnet

***01/08/2023*** `public-testnet-11`  (offline)

The testnet launched on 01/08/2023 at 17:00 UTC with the genesis validators from `public-testnet-11`. It launched with [version v0.20.1](https://github.com/anoma/namada/releases/tag/v0.20.1) and chain-id `public-testnet-11.3aaeae0d49ea`. 
If your genesis transaction is contained in [this folder](https://github.com/anoma/namada-testnets/tree/main/namada-public-testnet-11), you are one of the genesis validators. In order for the testnet to come online, at least 2/3 of those validators need to be online.
