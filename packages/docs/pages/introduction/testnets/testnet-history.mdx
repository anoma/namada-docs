...
***02/08/2023*** `public-testnet-11`  (online)

The testnet launched on 01/08/2023 at 17:00 UTC with the genesis validators from `public-testnet-11`. It launched with [version v0.20.1](https://github.com/anoma/namada/releases/tag/v0.20.1) and chain-id `public-testnet-11.cc649ddd49b0`. 
