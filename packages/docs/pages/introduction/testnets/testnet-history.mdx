...
No upgrade needed on `public-testnet-10` (yet).

## Latest Testnet

***29/06/2023*** `public-testnet-10`  (offline)

The testnet launched on 26/07/2023 at 17:00 UTC with the genesis validators from `public-testnet-10`. It launched with [version v0.17.5](https://github.com/anoma/namada/releases/tag/v0.17.3) and chain-id `public-testnet-10.3718993c3648`. 
