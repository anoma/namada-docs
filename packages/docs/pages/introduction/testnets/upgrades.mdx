...
***29/06/2023*** `public-testnet-10` 

The testnet launched on 29/06/2023 at 17:00 UTC with the genesis validators from `public-testnet-10`. It launched with [version v0.17.5](https://github.com/anoma/namada/releases/tag/v0.17.3) and chain-id `public-testnet-10.3718993c3648`. 
...
***20/06/2023*** `public-testnet-9` 

The testnet launched on 20/06/2023 at 17:00 UTC with the genesis validators from `public-testnet-9`. It launched with [version v0.17.3](https://github.com/anoma/namada/releases/tag/v0.17.3) and chain-id `public-testnet-9.0.c2d503c57dc`. 
If your genesis transaction is contained in [this folder](https://github.com/anoma/namada-testnets/tree/main/namada-public-testnet-9), you are one of the genesis validators. In order for the testnet to come online, at least 2/3 of those validators need to be online.
...
The testnet launched on 29/03/2023 at 17:00 UTC with the genesis validators from `public-testnet-6`. It launched with [version v0.14.3](https://github.com/anoma/namada/releases/tag/v0.14.3) and chain-id `public-testnet-6.0.a0266444b06`. 
