...
The testnet launched on 17/08/2023 at 17:00 UTC with the genesis validators from `public-testnet-12`. It launched with [version v0.21.1](https://github.com/anoma/namada/releases/tag/v0.21.1) and chain-id `public-testnet-12.f2e89e279cb3`. 
