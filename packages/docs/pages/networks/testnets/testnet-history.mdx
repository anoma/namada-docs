...
No upgrade needed on `public-testnet-12` (yet).

## Latest Testnet

***17/08/2023*** `public-testnet-12`  (online)

The testnet launched on 17/08/2023 at 17:00 UTC with the genesis validators from `public-testnet-12`. It launched with [version v0.21.1](https://github.com/anoma/namada/releases/tag/v0.21.1) and chain-id `public-testnet-12.a1990c675623`. 
