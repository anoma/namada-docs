...
Learn more about the shielded pool on Namada beyond Namadillo [here](../shielded-accounts.mdx). 
...
Shielded rewards accrue each MASP epoch based on the amount of assets you have shielded, and are automatically added to your shielded *NAM* balance. You can 
view an estimate of your expected rewards per epoch both in the **MASP** and **Overview** (homepage) sections of Namadillo.  

On mainnet, one MASP epoch is equal to four epochs (that is, 24 hours).
