...
- [On-chain proposals](./governance/on-chain-governance.md): Proposal is voted on and tallied on-chain. This can optionally include proposal code to be executed if the proposal is accepted.
