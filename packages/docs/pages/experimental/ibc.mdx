...
We have our [fork of Hermes supporting Namada instances](https://github.com/heliaxdev/ibc-rs/tree/yuji/v0.14.0_namada).
...
`base-dir` is the base directory of each node. If you have used the script, the directory is `${IBC_RS}/data/namada-*/.namada`.
