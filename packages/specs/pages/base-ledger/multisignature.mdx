...
{/* What do encrypted (inner) WASM transactions have to do with k-of-n multisignatures? */}
{/* Why don't we call them threshold signatures? */}
...
{/* Which validity predicates check the signature? */}
{/* How many signatures do we need? And why? */}
...
{/* How does the algorithm look like? Is the execution complexity reduced because of this key-value table instead of a list? */}
...
```
{/* Where does this storage live? I'd like to see a wider picture. This doesn't tell me much */}
