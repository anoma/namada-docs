...
[spec](https://github.com/cometbft/cometbft/blob/main/spec/p2p/legacy-docs/peer.mdx)).
...
More details about gas, fees, and the unshielding transaction can be found in the [fee specs](../economics/fee-system.mdx).
