...
Offline votes are tallied under the same mechanism as [on chain vote tallying](./on-chain.md#tally), but instead of reading the data from storage it will require a list of serialized json votes.
