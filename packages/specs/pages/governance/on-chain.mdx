...
The correct logic to handle these different types will be hardcoded in protocol. 
...
Once a proposal has been accepted by the protocol as valid, it will be added to the pending proposals list, and will be available for voting.
