...
It is likely that there would only be such wide-spread disagreement if the proposal was misaligned with the users the stewards is attempting to cater to. 
