...
to Ethereum. Once this transaction is approved, a ["proof"](proofs.mdx), or 
...
pool. Namada calls this the _Bridge Pool_.
...
Timeouts only happen after Namada processes transfer to Ethereum events in order to guarantee
