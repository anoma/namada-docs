...
> Note: You need to have [joined a network](./introduction/quick-start/README.md) before you start the ledger. It throws an error if no network has been configured.
